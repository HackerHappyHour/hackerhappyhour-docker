...
class docker(
  ...
  $container_root_lv_name            = undef,
  $container_root_lv_mount_path      = undef,
  $container_root_lv_size            = undef,
  $root_size                         = '8G',
  $data_size                         = '40%FREE',
  $min_data_size                     = '2G',
  $pool_meta_size                    = '16M',
  ...
  $css_ensure = 'present',
  $css_apt_location = 'https://packagecloud.io/LongLiveCHIEF/container-storage-setup/debian',
  $css_apt_release = 'unstable',
  $css_apt_repos = 'main',
